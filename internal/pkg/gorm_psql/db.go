...
import (
	...
	"github.com/shantanuborade007/shop-go/internal/utils"
...
func NewGorm(config *GormPostgresConfig) (*gorm.DB, error) {
	...
	if config.DBName == "" {
		return nil, errors.New("DB name is required in config")
	}
	...
	bo.MaxElapsedTime = 10 * time.Second //max time to retry
